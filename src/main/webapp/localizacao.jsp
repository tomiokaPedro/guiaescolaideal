...
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
			...
			<!-- Carregando api do google. 'sensor' (é usado como um localizador de GPS) para determinar a localização do usuário-->
			<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
	</head>
	<body>
		<section>
	    	<article>
	        	<p><span id="status">Por favor aguarde enquanto nós tentamos localizar vocÃª...</span></p>
	    	</article>
		</section>
